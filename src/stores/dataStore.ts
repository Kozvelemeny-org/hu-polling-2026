...
import type { HistoricalSimulationData, MandateProjectionData, PartyData, PollData, PollsterData, PollsterGroup, Simulation } from '../lib/types';
...
export const historicalSimulationData = writable<HistoricalSimulationData>({});
...
export async function fetchData() {
    try {
        ...
        historicalSimulationData.set(data.historicalSimulationData);
    } catch (error) {
